...
'''
    ...
    with open("python_server.py", "w", encoding="utf-8") as f:
    ...
    def start_system(self):
        ...
        try:
            ...
            if not os.path.exists(server_script):
                messagebox.showerror("错误", f"找不到服务器文件: {server_script}")
                return
...
def main():
    ...
    # 构建便携版本
    if not build_portable_version():
        return False
    
    print("\n" + "=" * 50)
    print("便携版本构建完成！")
    print("可执行文件位于: dist/电池售后管理系统_便携版/")
    print("=" * 50)
